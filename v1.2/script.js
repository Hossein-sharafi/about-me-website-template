...
document.getElementById('link2').innerHTML='وبسایت';
document.getElementById('link2').href='https://www.minestar.top/';
document.getElementById('link3').innerHTML='';
document.getElementById('link3').href='';
document.getElementById('link4').innerHTML='';
document.getElementById('link4').href='';
...
function aynar(){
    ...
    document.getElementById('message').innerHTML='تیم ارائه خدمات نرم افزاری در زمینه های مختلف همچون طراحی سایت و اپلیکشن های موبایلی';
    ...
    document.getElementById('link3').innerHTML='وبسایت';
    document.getElementById('link3').href='https://www.aynar.xyz';
    document.getElementById('link4').innerHTML='';
    document.getElementById('link4').href='';
}
/*  soon
